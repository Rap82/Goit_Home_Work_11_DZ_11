...
# Примітка :  І з нового тут тільки магічний методи *__add__ і *__sub__ (є ще і всі інші , перелік шукай в теорії або в інтернті)
             # Магічний методи, які дозволяють міняти стандартну поведінку матиматичних знаків (+, -, *, / та інших) 
...
# Аналогічно методу *__add__(self,*інший_екзепляр) Працють всі інші магічні методи матиматичних символів(і мабудь не тільки матиматичних)
    # По факту імя магічного методу в Пайтон виступає просто як символ 
...
# vector2 = Vector(Point(1, 10))  # Створення конкретного екзепляру класу *Vector з іменем *vector 
# #                                # який в полі *coordinates  буде містити  екзепляр класу *Point шаблону *Point(x,y)
# #                                # В нашому випадку: поле *x == 1 а поле *y == 10
# # new_vektor = vector1 + vector2

# # print(new_vektor)  # (1, 10) # Прінтимо виклик без переданого аргументу, *vector() магічного методу *__call__ 
# #                            # реалізованого в нашому класі. Виведе # (1, 10)
# new_vektor = vector1 - vector2
# print(new_vektor) 
# # print(vector(5)) # (5, 50) # Прінтимо виклик з переданим аргументом 5, *vector(5) магічного методу *__call__ 
